      ...
      <div class="bg_image">
        ...
        <div class="left">
          <div class="carddl" >
            ...
            <div class="card-body">
              <h5 class="card-title">Quality-Assured Medicines</h5>
              <p class="card-text">Epharma is a one-stop-shop for all your healthcare needs, We have a range of categories and products</p>
        ...
        <div class="left">
          <div class="carddl" >
            ...
            <div class="card-body">
              ...
              <p class="card-text"> Order medicines online at Epharma, India’s trusted online medicine app.</p>
              <a href="#" class="btn btn-primary">Know More</a>
            </div>
          </div>
        </div>
