...
const Home = () => {
  ...
  useEffect(() => {
    (
      async () => {
        const response = await fetch('http://localhost:1552/api/Auth/User', {
          method: 'GET',
  ...
  const onGridReady = useCallback((params) => {
    axios.get('http://localhost:1552/api/Drug')
  ...
  return (
    <div class="bg_image">
      ...
      <div class="float-container">
        ...
        <h5 class="change">Welcome to EPharma&nbsp;&nbsp;&nbsp;{userName ? 'Hi,' + ' ' + userName : 'You are Not Logged In'}</h5>
